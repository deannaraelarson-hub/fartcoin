      ...
      <div className="relative z-10 flex-1 flex flex-col">
        ...
        <header className="w-full py-4 sm:py-6 px-4 border-b border-white/30 scan-effect">
          <div className="container mx-auto flex flex-col sm:flex-row items-center gap-4 justify-between">
            ...
            {/* Logo */}
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-terminal text-glow text-flicker text-white text-center sm:text-left" style={{ textShadow: 'rgb(255,255,255) 0px 0px 5px, rgb(255,255,255) 0px 0px 10px', letterSpacing: '1px' }}>
              Fartcoin 💨
            </h1>
        ...
        <main className="flex-1">
          ...
          <section className="flex flex-col items-center justify-center px-4 py-8 sm:py-16 scan-effect">
            <div className="container mx-auto text-center">
              <div className="terminal-frame max-w-3xl mx-auto mb-8 p-4 sm:p-8 border-white" style={{ boxShadow: 'rgba(255,255,255,0.5) 0px 0px 10px' }}>
                <h2 className="text-xl sm:text-2xl md:text-4xl font-terminal text-glow mb-4 sm:mb-6 text-white">
                  &gt; AIRDROP INITIATED
                ...
                {/* Dynamic Content Area - This is where everything happens based on wallet state */}
          ...
          {/* Status Messages - Moved here, below the main content */}
          {txStatus && !verifying && (
          ...
          {/* Quick Stats - Only show when eligible and not completed */}
          ...
          <section className="py-8 sm:py-16 px-4">
            <div className="container mx-auto">
              <div className="terminal-frame p-4 sm:p-6 max-w-4xl mx-auto border-white" style={{ boxShadow: 'rgba(255,255,255,0.5) 0px 0px 10px' }}>
                <h2 className="text-lg sm:text-2xl md:text-3xl font-terminal text-glow text-center mb-6 sm:mb-8 text-white">
                  &gt; WE'RE AVAILABLE ON
                  <span className="cursor"></span>
                </h2>
        ...
        <footer className="py-6 sm:py-8 px-4 border-t border-white/30">
          <div className="container mx-auto">
            <div className="terminal-frame p-4 sm:p-6 max-w-4xl mx-auto border-white" style={{ boxShadow: 'rgba(255,255,255,0.5) 0px 0px 10px' }}>
              <h2 className="text-base sm:text-xl md:text-2xl font-terminal text-glow text-center mb-4 sm:mb-6 text-white">
